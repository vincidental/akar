          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.15 }}>
              <div className="bg-white rounded-2xl border border-black/8 shadow-sm overflow-hidden">
                ...
                <div id="calendly-strategy" className="min-h-[500px] flex flex-col items-center justify-center gap-4 p-8 bg-[#F8F6F2]">
                  <div className="text-center">
                    ...
                    <h4 className="font-serif text-lg text-[#1a1a1a] mb-2">{c.calLabel}</h4>
                    <p className="text-sm text-[#1a1a1a]/45 max-w-xs mb-6">{c.calSub}</p>
                    ...
                    <div className="mt-8 pt-6 border-t border-black/6">
                      <p className="text-xs text-[#1a1a1a]/30 mb-3">{c.altContact}</p>
                      <a href="https://wa.me/62" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-[#1a1a1a] text-white font-medium rounded-full text-sm hover:bg-[#333] transition-colors">

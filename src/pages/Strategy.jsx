      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            >
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-green-600 mb-5">Systems Architecture</p>
              ...
              <p className="text-base text-[#1a1a1a]/55 leading-relaxed mb-10">
                Book an in-depth strategy session with our engineering team. Whether you need to dominate your local Google Maps rankings, implement 24/7 AI lead automation, or build custom operational software, let's map out your exact infrastructure.
              </p>
            ...
            >
              <div className="bg-white rounded-2xl border border-black/8 shadow-sm overflow-hidden">
                <div className="px-7 py-6 border-b border-black/6">
                  <h3 className="font-serif text-xl text-[#1a1a1a]">Book Your Strategy Session</h3>
                  <p className="text-sm text-[#1a1a1a]/45 mt-1">Select a time that works for you</p>
                </div>
                <div
                  id="calendly-strategy"

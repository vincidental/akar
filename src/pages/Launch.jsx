  ...
  return (
    <div className="bg-[#F0EDE8] min-h-screen relative">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 group w-12 h-12 md:w-14 md:h-14 flex items-center justify-center rounded-full bg-[#3a8c5c] hover:bg-[#2a7a4f] shadow-lg shadow-[#3a8c5c]/20 hover:shadow-[#3a8c5c]/30 transition-all duration-300 hover:scale-105"
            ...
            >
              <div className="bg-white rounded-2xl border border-black/8 shadow-sm overflow-hidden sticky top-28">
                ...
                <div className="px-7 py-5 border-t border-black/6 bg-white flex flex-col sm:flex-row items-center justify-between gap-3">
                  ...
                  <a href="https://wa.me/6281809006757" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 bg-green-600 text-white font-medium rounded-full text-sm hover:bg-green-700 transition-colors">
